...
import fr.eni.papeterie.ihm.CatalogueController.CatalogueControllerListener;

public class EcranArticle extends JFrame implements IPanelBoutonsObserver, CatalogueControllerListener {
	...
	public EcranArticle() {
		...
		CatalogueController.getInstance().addListener(this);
		...
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(EcranArticle.this, "Pas d'articles dans le catalogue");
		}
	}
	...
	private JPanel getPanelBoutons() {
		if (panelBoutons == null) {
			panelBoutons = PanelBoutons.getInstance();
	...
	public void suivant() {
		try {
			...
			ae.printStackTrace();
			JOptionPane.showMessageDialog(EcranArticle.this, "Vous avez atteint la fin de la liste");
	...
	public void precedent() {
		try {
			...
			ae.printStackTrace();
			JOptionPane.showMessageDialog(EcranArticle.this, "Vous avez atteint le début de la liste");
		} catch (BLLException be) {
			be.printStackTrace();
		}
	}
...
//			}
	...
	@Override
	public void onArticleSelectionne(Article article) {
