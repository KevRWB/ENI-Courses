...
insert into conges_mens values (@myid,2006,3,10)

SET @myid = -4
insert into employes (codeemp,nom,prenom,dateEmbauche,salaire,codeService,codeChef)
	values (@myid,'Cover','Harry','01/09/2005',2500,'INFOR',null);
SELECT * FROM Conges_Mens;
...
insert into conges values (@myid,2005,8)
SAVE TRAN BEFORE_INSER_EMP;
SELECT * FROM Conges
insert into conges_mens values (@myid,2005,8,5)
...
--ROLLBACK TRAN BEFORE_INSER_EMP;

--ROLLBACK TRAN [tran_bouchon];